...
#' The Microsoft Visual Studio \code{vsvars323.bat} file is used to set include paths and environment
...
compileAll <- function(filepath)
	...
	if(is.null(getOption("VSPATH"))){
		stop("...The vsvars32.bat filepath has not been set in options. This MUST be done before compiliation", call. = FALSE)
	}
